package gr.agroscape.external.behaviors.productionRealization;
...
public class ProductionRealizationBehaviorContext extends BehaviorContext {
	
	
	private GridValueLayer yields;
	

	protected ProductionRealizationBehaviorContext() {
